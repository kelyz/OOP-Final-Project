...
public class Main {
	...
	public static void main (String [] args) throws IOException, SAXException, ParserConfigurationException, NullPointerException {
		...
		try {
			...
			//If there is no definition, the user can input his/her own defintion
			...
			if (uniqueWords.size() > 4) {
				...
				System.out.println("There are not enough words to make a quiz. Please input a larger text file.");
			}
			sc.close();
